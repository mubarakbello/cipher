...
/**
 * Performs column transposition on `text` with the given `key` and `subkey2`.
 *
 * @param {string} [text]
 * @param {string} [key]
 * @param {Array<number>} [subkey2]
 * @return {string} which is the transposed string
 */

module.exports.columnTransposition = (text, key, subkey2) => {
...
/**
 * Performs inverse column transposition on `text`
...
module.exports.inverseColumnTransposition = (text, key, subkey2) => {
