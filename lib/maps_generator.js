/**
 * Generate two hashmaps `map` and `inverse` from the given `subkey1`.
 *
 * @param {String} [subkey1]
 * @return {Object} {map, inverse}
 */
...
/**
 * Generate a distinct random number that doesn't exist in the given `visited`.
 *
 * @param {number} [q]
 * @param {Object} [visited]
 * @return {Object} {rand, q_next}
 */
