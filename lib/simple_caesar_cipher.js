/**
 * Performs simple caesar cipher transposition on `plainText` with the given `_map`.
 *
...
/**
 * Performs inverse caesar cipher transposition on `cipheredText` with the given `_inverse_map`.
 *
